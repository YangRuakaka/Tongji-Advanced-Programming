...
public:
	...
	double area()
	{
		if (p1.getx() * p2.gety() * 1 + p2.getx() * p3.gety() * 1 + p3.getx() * p1.gety() * 1 - p1.getx() * p3.gety() * 1 - p2.getx() * p1.gety() * 1 - p3.getx() * p2.gety() * 1)
			return fabs((1.00 / 2) * (p1.getx() * p2.gety() * 1 + p2.getx() * p3.gety() * 1 + p3.getx() * p1.gety() * 1 - p1.getx() * p3.gety() * 1 - p2.getx() * p1.gety() * 1 - p3.getx() * p2.gety() * 1));
		else
			return -1;
	}
	/* 构造函数 */
